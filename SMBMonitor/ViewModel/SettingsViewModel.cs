...
public class SettingsViewModel : BaseViewModel
{
    ...
    {
        _settingsModel = ModelsContainer.Instance.SettingsModel;
    ...
    private void SelectLogFileProc()
    {
        var openFileDialog = new OpenFileDialog
        {
            ...
            InitialDirectory = Path.GetDirectoryName(_settingsModel.LogFilename),
            FileName = Path.GetFileName(_settingsModel.LogFilename),
            DefaultExt = "log",
